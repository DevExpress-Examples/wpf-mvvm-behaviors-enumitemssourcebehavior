<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/128642392/20.2.1%2B)
...
# How to: Set ImageSize with EnumItemsSourceBehavior
